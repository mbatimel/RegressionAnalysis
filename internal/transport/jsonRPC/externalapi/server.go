...
func (srv *Server) WithLog() *Server {
	if srv.httpRegression != nil {
		srv.httpRegression = srv.Regression().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpRegression != nil {
		srv.httpRegression = srv.Regression().WithMetrics()
	}
	return srv
}

func (srv *Server) Regression() *httpRegression {
	return srv.httpRegression
}
