...
func Test_MakeDataPoints(t *testing.T) {
	a := [][]float64{
		{1, 2, 3, 4},
		{2, 2, 3, 4},
		{3, 2, 3, 4},
...
func Test_GetCoeffs(t *testing.T) {
	a := [][]float64{
		{651, 1, 23},
		{762, 2, 26},
		{856, 3, 30},
...
func Test_PowCrosses(t *testing.T) {
...
func Test_MultiplicationCrosses(t *testing.T) {
...
func Test_FunctionalCrossExtendNames(t *testing.T) {
